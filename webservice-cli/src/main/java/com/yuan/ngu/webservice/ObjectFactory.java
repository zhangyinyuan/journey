 ...
 * generated in the com.yuan.ngu.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://webservice.ngu.yuan.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://webservice.ngu.yuan.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.yuan.ngu.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ngu.yuan.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ngu.yuan.com/", name = "sayResponse")
