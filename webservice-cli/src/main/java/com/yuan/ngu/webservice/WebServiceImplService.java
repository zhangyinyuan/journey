 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://webservice.ngu.yuan.com/", wsdlLocation = "http://localhost/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.ngu.yuan.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost/hello?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://webservice.ngu.yuan.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.ngu.yuan.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
