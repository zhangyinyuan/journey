...
public class HelloOSS {
    ...
    private static String accessKeyId = "LTAIKntZAj05Zqjl";
    private static String accessKeySecret = "JtS9MTv5R6xeiCRUPnvqPqTSvByIYM";
    ...
    public static void main(String[] args) {
        ...
        PropertyConfigurator.configure("aliyun-oss-java-sdk-demo/conf/log4j.properties");
        ...
        try {
            ...
            ossClient.putObject(bucketName, fileKey, new File("aliyun-oss-java-sdk-demo/README.md"));
